...
Azure ML supports three main approaches: **Automated ML** (the platform builds models for you), **Designer** (drag-and-drop visual pipelines), and **Notebooks** (write code directly). For the AI-901 exam, focus on understanding what each component does rather than how to code with it.
