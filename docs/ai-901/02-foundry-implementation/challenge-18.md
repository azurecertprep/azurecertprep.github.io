...
Azure provides two primary services for natural language processing: **Azure AI Language** for text-based NLP and **Azure AI Speech** for audio-based processing. Understanding which service handles which capability — and when to combine them — is essential for the AI-901 exam.
