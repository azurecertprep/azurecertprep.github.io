...
The AI-901 is a fundamentals exam. The challenges in this guide are exploration-based and designed to cost **$0** using Azure free-tier resources. No complex infrastructure or paid services are required.
...
Head to [Challenge 01: AI Workloads Overview](/docs/ai-901/ai-concepts/challenge-01) to start your AI-901 preparation.
