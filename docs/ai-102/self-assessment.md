...
### Mostly ✅: You're ready!
Jump straight to [Lab Setup](/docs/ai-102/lab-setup) and start Challenge 01.
...
- [AI-900: Azure AI Fundamentals](/docs/ai-900/overview) — Build foundational AI and Azure AI concepts
...
**Ready to go?** Head to the [Lab Setup](/docs/ai-102/lab-setup) to configure your environment, then start with [Challenge 01](/docs/ai-102/plan-manage/challenge-01).
