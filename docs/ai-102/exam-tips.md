...
:::warning Exam Retires June 30, 2026
...
- Review the [Coverage Matrix](/docs/ai-102/coverage-matrix) — any gaps?
...
- [ ] Review the [Cheat Sheet](/docs/ai-102/cheat-sheet) one final time (not during the exam!)
...
| **Free practice questions** | [Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/exams/ai-102/practice/assessment?assessment-type=practice&assessmentId=61) |
...
**Ready to start studying?** Head to [Challenge 01](/docs/ai-102/plan-manage/challenge-01).
