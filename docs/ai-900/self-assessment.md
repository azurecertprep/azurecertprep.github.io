...
You likely already know enough to pass. Use the challenges to fill any small gaps and confirm your knowledge. Consider jumping straight to the [exam tips](/docs/ai-900/exam-tips) and taking a practice test.
...
This is exactly who the AI-900 is designed for — people curious about AI who want a structured introduction. Start with [Challenge 01: AI Workloads Overview](/docs/ai-900/ai-workloads/challenge-01) and work through each module sequentially. The challenges build on each other and assume no prior knowledge.
