---
sidebar_position: 4
title: "Challenge 42: Search Queries — Syntax and Filters"
---
...
:::info Estimated Time
**45-60 min** | **Cost**: ~$0.10 (queries against existing index) | **Domain**: Information Extraction Solutions (15-20%)
:::
...
<KnowledgeCheck questions={[
  ...
  {
    id: "ai102-42-q4",
    question: "A field is defined as 'searchable: true, filterable: false, facetable: true'. Which operation will FAIL?",
    options: [
      "$filter=field eq 'value'",
      "Full-text search against the field",
      "Requesting facets for the field",
      "Including the field in $select"
    ],
    correctIndex: 0,
    explanation: "A field with filterable=false cannot be used in $filter expressions. Searchable=true allows full-text search, facetable=true allows facet aggregation, and any field can be included in $select regardless of other attributes."
  },
  {
    id: "ai102-42-q5",
