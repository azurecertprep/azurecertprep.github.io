...
:::info Estimated Time
**45-60 min** | **Cost**: ~$1.00 (estimated) | **Domain**: Generative AI & Agentic Solutions (35-40%)
:::
...
Azure OpenAI Service provides access to a variety of generative AI models through a managed deployment model. Choosing the right model and deployment type is a critical skill for the AI-103 exam. The **model catalog** includes GPT-4o (multimodal, high capability), GPT-4o-mini (cost-efficient for simpler tasks), and open-source models like Phi-4, Mistral, and Llama available through Models as a Service (MaaS).
