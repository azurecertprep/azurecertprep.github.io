...
Every official exam skill is mapped to at least one challenge. Use this matrix to ensure complete coverage.
...
| Skill | Challenge(s) |
|-------|-------------|
| Define cloud computing | 01 |
| Describe the shared responsibility model | 01 |
| Define cloud models (public, private, hybrid) | 01 |
| Identify appropriate use cases for each cloud model | 01 |
| Describe the consumption-based model | 03 |
| Compare cloud pricing models (CapEx vs OpEx) | 03 |
| Describe serverless | 03, 10 |
...
| Skill | Challenge(s) |
|-------|-------------|
| Describe Azure regions, region pairs, and sovereign regions | 07 |
| Describe availability zones | 07 |
| Describe Azure datacenters | 07 |
| Describe Azure resources and resource groups | 08 |
| Describe subscriptions | 08 |
| Describe management groups | 08 |
| Describe the hierarchy of resource groups, subscriptions, and management groups | 08 |

### Describe Azure compute and networking services

| Skill | Challenge(s) |
|-------|-------------|
| Compare compute types (containers, VMs, functions) | 09, 10 |
...
| Skill | Challenge(s) |
|-------|-------------|
| Compare Azure storage services (Blob, File, Queue, Table) | 13 |
| Describe storage tiers (hot, cool, cold, archive) | 14 |
| Describe redundancy options (LRS, ZRS, GRS, RA-GRS) | 14 |
| Describe storage account options and storage types | 13 |
| Identify options for moving files (AzCopy, Storage Explorer, Azure File Sync) | 15 |
| Describe migration options (Azure Migrate, Azure Data Box) | 15 |
...
| Describe the purpose of Microsoft Defender for Cloud | 18 |
...
| Skill | Challenge(s) |
|-------|-------------|
| Describe the purpose of Azure Advisor | 23 |
| Describe Azure Service Health | 23 |
| Describe Azure Monitor (including Log Analytics, Azure Monitor Alerts, Application Insights) | 24 |
