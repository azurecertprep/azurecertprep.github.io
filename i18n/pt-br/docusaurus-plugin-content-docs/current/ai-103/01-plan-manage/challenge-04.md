...
:::info Tempo Estimado
**45 min** | **Custo**: ~$0.25 | **Domínio**: Planejar e Gerenciar Soluções de IA (15-20%)
:::
...
Os Azure AI services podem ser consumidos via SDKs específicos de linguagem ou chamadas diretas à REST API. O exame AI-103 testa sua capacidade de escolher o método de autenticação correto, entender a construção de endpoints e lidar com versionamento de API corretamente.
