...
Criar e configurar recursos do Azure AI corretamente é a base de todo cenário do AI-103. Este desafio vai além de clicar em "Criar" no portal—você provisionará recursos programaticamente, configurará restrições de rede, recuperará e rotacionará chaves, e validará a conectividade do endpoint.
...
![Topologia do Desafio 02](/img/ai-103/challenge-02-topology.svg)
