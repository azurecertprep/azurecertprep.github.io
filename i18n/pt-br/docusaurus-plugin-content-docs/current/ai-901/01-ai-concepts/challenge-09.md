...
:::info Tempo Estimado
**25-35 min** | **Custo**: Gratuito | **Domínio**: Conceitos e Capacidades de IA (40-45%)
:::
...
O Azure ML suporta três abordagens principais: **Automated ML** (a plataforma constrói modelos para você), **Designer** (pipelines visuais drag-and-drop) e **Notebooks** (escrever código diretamente). Para o exame AI-901, foque em entender o que cada componente faz em vez de como programar com ele.
