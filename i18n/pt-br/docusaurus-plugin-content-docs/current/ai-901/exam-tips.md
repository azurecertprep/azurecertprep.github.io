...
| **Prerequisites** | None (basic Python reading helpful) |
...
**Domain 2: Implement AI Solutions Using Azure Foundry (55-60%)** is the heaviest section — over half the exam. Make sure you can:
- Navigate Microsoft Foundry portal and understand hub/project model
- Deploy models from the catalog and configure them
- Build basic agents and multi-turn chat apps
- Understand Content Understanding for document extraction
- Construct effective prompts (system vs user, visual prompts)
- Read basic Python/Foundry SDK code snippets
