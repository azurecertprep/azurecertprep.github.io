...
const stats = [
  { number: '181', label: 'Challenges' },
  { number: '4', label: 'Exams' },
...
export default function Home() {
  return (
    <Layout
      ...
      description="Don't just study — build it. Hands-on challenges for Azure certification exams. AZ-104, AZ-305, and AZ-400 available.">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
        <ChallengeGrid />
